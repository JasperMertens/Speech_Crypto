...
#     [file normalize $origin_dir/project_ipcore ] ] $obj
...
# set files [list \
#     [file normalize $origin_dir/src/rtl/accelerator.v ] \
#     [file normalize $origin_dir/src/rtl/accelerator_wrapper.v ] ]
add_files -norecurse -fileset [get_filesets sources_1] $files

set_property top accelerator_project_wrapper [get_filesets sources_1]

# Create block design
source $origin_dir/src/bd/project_bd.tcl
...
# set files [list \
    # [file normalize $origin_dir/src/rtl/tb_accelerator_wrapper.v ]]
...
# set files [list \
#     [file normalize $origin_dir/src/rtl/hweval_accelerator.v ] ]
